...
the numerical step. A table reserves particle rows for each system; an explicit
lens and index view select optimizer fields to reinitialize. Input sources and result writers remain
